...
Route::group(
    ...
    Route::resource('academic/classwork', 'ClassworkController');
    Route::resource('academic/classwork/topic', 'TopicController');
    Route::get('academic/classwork/assignment/{id}', 'AssignmentController@create')->name('assignment.create');
    Route::resource('academic/classwork/assignment', 'AssignmentController', ['except' => 'create']);
    Route::get('academic/classwork/question/{id}', 'QuestionController@create')->name('question.create');
    Route::resource('academic/classwork/question', 'QuestionController', ['except' => 'create']);
    Route::get('academic/classwork/classwork_attempt/{classwork_id}/{user_id}', 'ClassworkAttemptController@edit')->name('classwork_attempt.edit');
    Route::resource('academic/classwork/classwork_attempt', 'ClassworkAttemptController', ['except' => 'edit']);
    Route::resource('academic/classwork/classwork_grade', 'ClassworkGradeController');
