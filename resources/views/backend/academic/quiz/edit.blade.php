    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                <form novalidate id="entryForm" action="{{URL::Route('quiz.update', $quiz->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <input autofocus type="text" class="form-control" name="title" placeholder="Quiz Title" value="{{ old('title', $quiz->title) }}" required minlength="1" maxlength="255">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type='text' class="form-control date_picker2" readonly name="due_date" placeholder="Due Date" value="{{ old('due_date', $quiz->due_date) }} " maxlength="255" />
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group has-feedback">
                                    ...
                                    <input autofocus type="number" class="form-control" name="no_question" placeholder="Questions per attempt" value="{{ old('no_question', $quiz->no_question) }}">
                                    <span class="form-control-feedback"></span>
                            ...
                            <div class="col-md-9">
                                <div class="form-group has-feedback">
                                    ...
                                    <textarea name="instruction" class="form-control" maxlength="500"> {{ old('instruction', $quiz->instructions) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="checkbox" class="checkbox" @if($quiz->auto_grade == '1') checked @endif name="auto_grade">
                                ...
                                <div class="col-12" id="constrain_quiz_div">
                                    ...
                                    <input type="checkbox" class="checkbox" id="constrain_quiz" checked name="constrain_quiz">
                            ...
                            <div class="col-md-3 hide-div" id="module_activities">
                                <div class="form-group has-feedback">
                                    ...
                                    {!! Form::select('module_id', $modules, $quiz->constrain_id, ['class' => 'form-control select2', 'required' => 'true']) !!}
                                    <span class="form-control-feedback"></span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group has-feedback">
                                    ...
                                    {!! Form::select('quiz_question_type', AppHelper::QUIZ_QUESTION_TYPE, $quiz->question_type, ['placeholder' => 'Select Quiz Type', 'class' => 'form-control select2', 'id' => 'quiz_type', 'required' => 'true']) !!}
                                    <span class="form-control-feedback"></span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group has-feedback">
                                    ...
                                    <select name="quiz_status" id="quiz_status" required class="'form-control select2">
                                        <option value="{{AppHelper::ACTIVE}}" @if($quiz->status == 1) selected @endif>Active</option>
                                        <option value="{{AppHelper::INACTIVE}}" @if($quiz->status == 0) selected @endif>Inactive</option>
                                    </select>
                                    <span class="form-control-feedback"></span>
                                    <span class="text-danger">{{ $errors->first('quiz_type') }}</span>
                                </div>
