                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        ...
                                        {!! Form::select('nationality', ['Nigeria' => 'Nigeria', 'Other' => 'Other'], $nationality , ['class' => 'form-control', 'required' => 'true']) !!}
                                        <span class="form-control-feedback"></span>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input  type="text" class="form-control" name="nationality_other" @if(!$student || $student->nationality == "Nigeria") readonly @endif placeholder="Nationality" value="@if($student && $student->nationality != "Nigeria"){{$student->nationality}}@else{{old('nationality')}}@endif" maxlength="50" >
