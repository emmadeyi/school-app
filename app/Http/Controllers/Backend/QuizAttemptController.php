...
class QuizAttemptController extends Controller
{
    ...
    public function getAttemptQuestions(Request $request, $id)
    {
        ...
        foreach ($questions as $question) {
            ...
            array_push($questions_array, ['id' => $question->id, 'question' => $question->question, 'multichoice' => $multichoice, 'answers' => $answers_array]);
        }
        if ($request->ajax()) {
    ...
    public function store(Request $request)
    {
        ...
        foreach ($attempts as $attempt) {
            ...
            $attemptCount = $this->checkAttempt($quiz->id, $question->id);
            if ($multichoice) {
        ...
        return response()->json(["message" => $msg, $attemptCount], 200);
    }
